...
gcloud container clusters get-credentials projects/its-my-data-pipeline/zones/us-central1-b/clusters/us-central1-dev-composer-de094856-gke \
    --zone us-central1-b \
    --project its-my-data-pipeline
